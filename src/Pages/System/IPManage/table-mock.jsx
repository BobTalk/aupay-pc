...

    {
      ...
      render: (_, record) => {
        return <div className='flex items-center gap-[.2rem]'>
          {true ?
            <div className='text-[var(--pink)]' onClick={(e) => { disableCb(e, record) }}>
              <LockOutlined className='mr-[.1rem]' />已禁用
            </div>
            : <div className='text-[var(--green)]' onClick={(e) => { enableCb(e, record) }}>
              <UnlockOutlined className='mr-[.1rem]' /> 已开启
            </div>
          }
          <div className='text-[var(--menu-color)]' onClick={(e) => { deleteCb(e, record) }}>
