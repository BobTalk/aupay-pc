...
export const activePathToName = {
  ...
  "/aupay/address/user": ["用户地址"],
  "/aupay/address/transfer": ["中转地址"],
  "/aupay/address/reserve": ["储备资产"],
  "/aupay/address/draw": ["提币地址"],
  "/aupay/address/minerFees": ["矿工费地址"],
  "/aupay/ozbet/assets": ["Ozbet资产地址"],
  "/aupay/ozbet/draw": ["Ozbet提款地址"],
  "/aupay/ozbet/assets/transfer-records": ["Ozbet提款地址", "转账记录"],
  "/aupay/personal": ["个人资料"],
  "/aupay/system/staff-manage": ["员工管理"],
  "/aupay/system/logs-manage": ["日志记录"],
  "/aupay/system/rate-manage": ["汇率管理"],
  "/aupay/system/draw": ["提币设置"],
  "/aupay/system/automated": ["自动化配置"],
  "/aupay/system/ip-record": ["IP记录"],
  "/aupay/system/ip-manage": ["IP管理"],
  "/aupay/notice": ["公告列表"],
  "/aupay/notice/add": ["公告列表", "新增公告"],
  "/aupay/system/staff-manage/detail": ["员工管理", "详情"],
};
